...
from galaxybrain.search_learner import (
...
class TestSearchLearnerWeakSearch:
    ...
    async def test_weak_search_starts_session(self, learner):
        event = ToolCallEvent(
            tool_name="mcp__galaxybrain__jit_search",
...
class TestConstants:
    def test_galaxybrain_search_tools(self):
        assert "mcp__galaxybrain__jit_search" in GALAXYBRAIN_SEARCH_TOOLS
